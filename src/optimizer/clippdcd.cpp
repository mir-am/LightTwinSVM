...
- pybind11 for creating python bindings (https://pybind11.readthedocs.io)
...
PYBIND11_MODULE(clippdcd, m) {
    m.doc() = "ClippDCD opimizer implemented in C++ and improved by Mir, A."; // optional module docstring
