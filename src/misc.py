...
def progress_bar_gs(iteration, total, e_time, accuracy, best_acc, prefix='', suffix='', decimals=1, length=25, \
                    fill='#'):
	"""
	...
	print(output % (prefix, best_acc[0], best_acc[1], accuracy[0], accuracy[1], bar, \
          percent, suffix, e_time), end='\r')
